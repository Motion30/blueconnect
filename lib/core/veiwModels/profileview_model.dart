...
class ProfileViewModel extends BaseModel{
  ...
  Future updateProfile({ String fullName, String email, String phone , String quote }) async{
    setState(ViewState.Busy);
     ...
     if(result is bool){
       _dialogService.showDialog(title: "Success", buttonTitle: "Ok", description: "Profile updated successfully.");
     }else{
       _dialogService.showDialog(title: "Error", buttonTitle: "Ok", description: "Profile update failed. Try again later");
     }
  }
